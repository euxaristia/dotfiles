...
- Before pushing, check whether the target branch is protected (e.g. `gh api repos/{owner}/{repo}/branches/{branch}/protection` or try a dry-run); if protected, create a feature branch and open a PR instead of pushing directly
